...
import com.ewu.bug.swv.AndroidMultiPartEntity.ProgressListener;
import com.ewu.bug.swv.model.GPSLoc;
import com.ewu.bug.swv.utils.Config;
...
public class UploadActivity2 extends Activity {
    ...
    //String INSERT_URL = "http://178.62.200.168/testproject/tutorial/insertData.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = PrefUtils.getString(PrefUtils.USER_NAME, "none");
        contact = PrefUtils.getString(PrefUtils.USER_NO,"none");

        if(name==null ||contact==null){
            pToast("Name, Contact is Null");
            name="none";
            contact="none";
        }
        ...
        fileName = getCodeFromFilePath(filePath);
        ...
        if (filePath != null) {
            ...
            pToast("Sorry, file path is missing!");
        }
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mGpsLoc != null && NetworkTools.isConnectingToInternet(getApplicationContext())) {
                    ...
                    upData(Config.INSERT_URL, fileName, mGpsLoc);
                    new UploadFileToServer().execute();
                    ...
                    pToast("Check Network Connection & Location Service");
                }
    ...
    private void upData(String insertUrl, final String code, final GPSLoc gpsLoc) {
...
//                parameters.put("age", "10");
    ...
    private GPSLoc getLocation() {
        ...
        if (gps.canGetLocation()) {
            ...
            Log.d(TAG, "Your Location is: (" + latitude + "," + longitude + ")");
    ...
    private void showAlert(String message) {
        ...
        String title = "Response from Servers";
        //title = "Confirmation";
