...
public class AccelerometerManager {
	...
	private static float threshold = 13.0f;
	//private static int interval = 500;
	private static long interval = 100000000*1;
	...
	private static SensorEventListener sensorEventListener = new SensorEventListener() {
		...
		public void onSensorChanged(SensorEvent event) {
			...
			String value = "value (x,y,z): " + "(" + x + "," +  y + "," +  z + ")";
			//Log.d("xxx",value);
			...
			if (lastUpdate == 0) {
				...
				if (timeDiff > 0) {
					...
					//Log.d("xxx","force: " + force + " thresold: " + threshold);
					...
					if (Float.compare(force, threshold) > 0) {
						...
						if (now - lastShake >= interval) {
							//Log.d("xxx","trigger shake event");
							// trigger shake event
							Log.d("xxx","now: " + now +" - lastShake: " + lastShake + " = " + (now-lastShake));
