...
public class NewProductActivity extends AppCompatActivity {
    ...
    //private static String url_create_product = "http://192.168.0.105/AndroidFileUpload/fileUpload.php";
    private static String url_create_product = "http://192.168.0.106/aaproject/create_product.php";
